...
Most of the note taking apps don't take sync conflicts seriously. Often you can see duplicates of conflicting notes as a resolution. Since I'm using Git here, I decided to take advantage of that.
